...
<head>
    ...
    <link href="<c:url value="/resources/css/editgroups.css" />" rel="stylesheet">
    <!-- Bootstrap CSS -->
...
<div align="center">
	<form:form class="edit-group-form" action="editgroup" method="post" commandName="editGroupForm">
	  ...
	  <div>
	  	...
	  	<button type="submit" class="btn btn-success button">Edit Group</button>
	  </div>		  
	</form:form>
</div>
